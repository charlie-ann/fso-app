...
class SupportRequestPage extends ConsumerStatefulWidget {
  static const String routeName = 'support-request-page';
...
class _SupportRequestPageState extends ConsumerState<SupportRequestPage> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    final requestList = ref.watch(requestListProv);
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Support Requests",
